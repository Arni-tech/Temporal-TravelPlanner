...
def prompt_chatgpt(system_input, user_input, temperature,save_path,index,history=[], model_name='gpt-3.5-turbo-0125'):
    '''
...
def build_plan_format_conversion_prompt(directory, set_type='validation',model_name='gpt4',strategy='direct',mode='two-stage', num_samples=100):
    prompt_list = []
...
"""
    ...
    idx_number_list = [i for i in range(1,num_samples + 1)]
    if mode == 'two-stage':
        suffix = ''
